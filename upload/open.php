...
if ($_POST) {
    ...
    if(($ticket=Ticket::create($vars, $errors, SOURCE))){
        ...
        if($thisclient && $thisclient->isValid()) {
            ...
            $_SESSION['mensaje'] = '¡Su solicitud se envió correctamente!';
...
require(CLIENTINC_DIR.'header.testa.poslogin.inc.php');
if ($ticket
    && (
...
require(CLIENTINC_DIR.'footer.testa.poslogin.inc.php');
?>
