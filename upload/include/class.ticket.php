...
implements RestrictedAccess, Threadable {
    ...
    static $meta = array(
        'select_related' => array('topic','category', 'staff', 'user', 'team', 'dept', 'sla', 'thread',
            'user__default_email'),
    );
   ...
   function onOverdue($whine=true, $comments="") {
    ...
    static function getVarScope() {
        $base = array(
            ...
            'category' => array(
                'class' => 'Category', 'desc' => __('Category'),
            ),
    ...
    function update($vars, &$errors) {
        ...
        // $fields['categoryId']  = array('type'=>'int',      'required'=>1, 'error'=>__('Category is required'));
    ...
    static function create($vars, &$errors, $origin, $autorespond=true,
        ...
        switch (strtolower($origin)) {
            case 'web':
                ...
                // $fields['categoryId']  = array('type'=>'int',  'required'=>1, 'error'=>__('Select a Category'));
                break;
            case 'staff':
        ...
        foreach ($topic_forms as $topic_form) {
            ...
            $dat = $topic_form->setTicketId($ticket->getId());
            print var_dump($dat);
            print 'aqui';
            //$topic_form->save();
        }
